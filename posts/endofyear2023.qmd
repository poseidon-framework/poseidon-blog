...
![AI-generated watercolour drawing of the god Poseidon in the midst of a roaring sea. His shoulder features the number 2023. Created with Microsoft Bing Image Creator.](endofyear2023_media/poseidon_2023_bing_AI.jpeg)
...
- Selecting packages by version in the forge selection language and generally handling multiple package versions (v1.4.0.2, Stephan shared a [blog post](https://blog.poseidon-adna.org/posts/trident_14.html) about this release)
...
The last domain where we made good progress in 2023 is public outreach. Naturally we invested hours in writing and updating documentation on the website, but we also pursued a number of special projects beyond the basic, technical description of software and workflows.

The first one of these was possible thanks to the effort of Dhananjaya, Stephan and me: We built [a page on the website](https://www.poseidon-adna.org/#/archive_explorer) where the data in the public archives can be easily explored. It makes use of the Web-API provided by our webserver to access the data and display it with a subpage for each package. Dhananjaya wrote [a post](https://blog.poseidon-adna.org/posts/Archive_explorer_Blogpost.html) about this, recently.

This blog I already mentioned multiple times above is indeed another great addition of 2023. In fact, you're reading it right now. Stephan created this separate website to share news and short tutorials more easily with the world. Our wish is to gather an active and engaged community of users around Poseidon, and we hope to establish this blog as a major medium for longer write-ups beyond the technical documentation already available on the project website https://www.poseidon-adna.org.

To share our blog posts, software releases and other news we switched from twitter (now X) to the fediverse in 2023. You can follow us here: https://ecoevo.social/@poseidon. The switch came naturally, given the state of affairs at X. Submitting posts automatically is more easy with mastodon compared to twitter and I made sure that this process works reliably for our software releases on GitHub.
...
Much has happened for Poseidon in 2023 and I'm sure I'm not doing all of it due justice in this little summary. But I consider this already an impressive list that stands witness for the effort we put into the framework this year. And it seems to pay off, although I can't quantify it: The user-base is growing continuously. This helps us in turn to find and address remaining issues and make Poseidon better for all of us. This will also be one of my main tasks in the coming 2024.
